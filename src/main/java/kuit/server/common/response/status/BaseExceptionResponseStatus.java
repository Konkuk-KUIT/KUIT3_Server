...
public enum BaseExceptionResponseStatus implements ResponseStatus {
     ...
     * 6000: Restaurant 오류
     */
    INVALID_RESTAURANT_VALUE(6000, HttpStatus.BAD_REQUEST.value(), "잘못된 restaurant id 요청입니다."),

    /**
     * 7000: Menu 오류
     */
    INVALID_MENU_VALUE(7000, HttpStatus.BAD_REQUEST.value(), "메뉴추가 요청에서 잘못된 값이 존재합니다."),
    INVALID_MENU_STATUS(7001, HttpStatus.BAD_REQUEST.value(), "잘못된 menu status 값입니다.");
